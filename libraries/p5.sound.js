...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) { define('p5.sound', ['p5'], function (p5) { (factory(p5)) }) } else if (typeof exports === 'object') { factory(require('../p5')) } else { factory(root['p5']) }
}(this, function (p5) {
  /**
    ...
    p5.AudioIn.prototype.start = function (successCallback, errorCallback) {
      ...
      // set the audio source
        ...
        window.navigator.getUserMedia(constraints, this._onStream = function (stream) {
          ...
          if (errorCallback) { errorCallback(e) } else { console.error(e) }
        })
      } else {
